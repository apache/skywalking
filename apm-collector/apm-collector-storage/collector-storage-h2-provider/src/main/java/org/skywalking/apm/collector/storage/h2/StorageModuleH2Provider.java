...
import org.skywalking.apm.collector.storage.h2.dao.ApplicationReferenceH2MetricPersistenceDAO;
...
public class StorageModuleH2Provider extends ModuleProvider {
    ...
    private void registerPersistenceDAO() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IApplicationReferenceMetricPersistenceDAO.class, new ApplicationReferenceH2MetricPersistenceDAO(h2Client));
        ...
        this.registerServiceImplementation(IServiceReferenceMetricPersistenceDAO.class, new ServiceReferenceH2MetricPersistenceDAO(h2Client));
