 ...
 */
public class ServiceReferenceHourMetricEsPersistenceDAO extends AbstractServiceReferenceMetricEsPersistenceDAO implements IServiceReferenceHourMetricPersistenceDAO<Index, Update, ServiceReferenceMetric> {

    public ServiceReferenceHourMetricEsPersistenceDAO(ElasticSearchHttpClient client) {
        super(client);
    }
