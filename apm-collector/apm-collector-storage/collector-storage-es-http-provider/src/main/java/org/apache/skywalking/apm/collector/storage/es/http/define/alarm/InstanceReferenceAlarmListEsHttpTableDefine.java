 ...
 * @author cyberdak
 */
public class InstanceReferenceAlarmListEsHttpTableDefine extends ElasticSearchTableDefine {

    public InstanceReferenceAlarmListEsHttpTableDefine() {
        super(InstanceReferenceAlarmListTable.TABLE);
    }
