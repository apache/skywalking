...
package org.apache.skywalking.apm.collector.storage.es.http.define.gc;
 ...
 * @author cyberdak
 */
public abstract class AbstractGCMetricEsHttpTableDefine extends ElasticSearchTableDefine {

    public AbstractGCMetricEsHttpTableDefine(String name) {
        super(name);
    }
