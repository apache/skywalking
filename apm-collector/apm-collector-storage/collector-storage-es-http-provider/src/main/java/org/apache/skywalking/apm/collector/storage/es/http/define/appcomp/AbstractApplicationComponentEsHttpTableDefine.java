 ...
 * @author cyberdak
 */
public abstract class AbstractApplicationComponentEsHttpTableDefine extends ElasticSearchTableDefine {

    AbstractApplicationComponentEsHttpTableDefine(String name) {
        super(name);
    }
