...
package org.apache.skywalking.apm.collector.storage.es.http.define.srmp;
 ...
 * @author cyberdak
 */
public abstract class AbstractServiceReferenceMetricEsHttpTableDefine extends ElasticSearchTableDefine {

    public AbstractServiceReferenceMetricEsHttpTableDefine(String name) {
        super(name);
    }
