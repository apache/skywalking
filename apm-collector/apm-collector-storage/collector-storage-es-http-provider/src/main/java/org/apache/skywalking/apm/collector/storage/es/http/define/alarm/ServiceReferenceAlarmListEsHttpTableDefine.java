 ...
 * @author cyberdak
 */
public class ServiceReferenceAlarmListEsHttpTableDefine extends ElasticSearchTableDefine {

    public ServiceReferenceAlarmListEsHttpTableDefine() {
        super(ServiceReferenceAlarmListTable.TABLE);
    }
