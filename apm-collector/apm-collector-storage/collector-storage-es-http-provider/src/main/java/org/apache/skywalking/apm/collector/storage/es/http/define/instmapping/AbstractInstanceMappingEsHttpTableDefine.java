...
package org.apache.skywalking.apm.collector.storage.es.http.define.instmapping;
 ...
 * @author cyberdak
 */
public abstract class AbstractInstanceMappingEsHttpTableDefine extends ElasticSearchTableDefine {

    AbstractInstanceMappingEsHttpTableDefine(String name) {
        super(name);
    }
