 ...
 * @author cyberdak
 */
public abstract class AbstractApplicationMappingEsHttpTableDefine extends ElasticSearchTableDefine {

    AbstractApplicationMappingEsHttpTableDefine(String name) {
        super(name);
    }
