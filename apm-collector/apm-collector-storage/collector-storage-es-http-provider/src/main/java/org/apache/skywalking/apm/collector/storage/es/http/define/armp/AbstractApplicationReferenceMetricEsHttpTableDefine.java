 ...
 * @author cyberdak
 */
public abstract class AbstractApplicationReferenceMetricEsHttpTableDefine extends ElasticSearchTableDefine {

    public AbstractApplicationReferenceMetricEsHttpTableDefine(String name) {
        super(name);
    }
