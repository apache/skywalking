...
package org.apache.skywalking.apm.collector.storage.es.http.define.memory;
 ...
 * @author cyberdak
 */
public abstract class AbstractMemoryMetricEsHttpTableDefine extends ElasticSearchTableDefine {

    public AbstractMemoryMetricEsHttpTableDefine(String name) {
        super(name);
    }
