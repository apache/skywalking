...
package org.apache.skywalking.apm.collector.storage.es.http.define.cpu;
 ...
 * @author cyberdak
 */
public abstract class AbstractCpuMetricEsHttpTableDefine extends ElasticSearchTableDefine {

    public AbstractCpuMetricEsHttpTableDefine(String name) {
        super(name);
    }
