...
package org.apache.skywalking.apm.collector.storage.es.http.define.mpool;
 ...
 * @author cyberdak
 */
public abstract class AbstractMemoryPoolMetricEsHttpTableDefine extends ElasticSearchTableDefine {

    public AbstractMemoryPoolMetricEsHttpTableDefine(String name) {
        super(name);
    }
