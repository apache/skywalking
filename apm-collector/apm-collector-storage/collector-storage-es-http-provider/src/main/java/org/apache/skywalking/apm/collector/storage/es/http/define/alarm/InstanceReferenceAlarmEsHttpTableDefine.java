 ...
 * @author cyberdak
 */
public class InstanceReferenceAlarmEsHttpTableDefine extends ElasticSearchTableDefine {

    public InstanceReferenceAlarmEsHttpTableDefine() {
        super(InstanceReferenceAlarmTable.TABLE);
    }
