 ...
 * @author cyberdak
 */
public class StorageModuleEsHttpNamingListener extends ClusterModuleListener {

    private static final String PATH = "/" + StorageModule.NAME + "/" + StorageModuleEsHttpProvider.NAME;
