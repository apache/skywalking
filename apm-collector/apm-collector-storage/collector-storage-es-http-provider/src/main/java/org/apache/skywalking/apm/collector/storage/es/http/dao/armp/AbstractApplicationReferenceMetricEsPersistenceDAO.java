...
import org.apache.skywalking.apm.collector.storage.es.http.base.dao.AbstractPersistenceEsDAO;
...
public abstract class AbstractApplicationReferenceMetricEsPersistenceDAO extends AbstractPersistenceEsDAO<ApplicationReferenceMetric> {
    ...
    AbstractApplicationReferenceMetricEsPersistenceDAO(ElasticSearchHttpClient client) {
        super(client);
    }
