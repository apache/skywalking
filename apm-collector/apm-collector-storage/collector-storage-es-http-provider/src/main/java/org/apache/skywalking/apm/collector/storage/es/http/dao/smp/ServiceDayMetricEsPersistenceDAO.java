 ...
 * @author cyberdak
 */
public class ServiceDayMetricEsPersistenceDAO extends AbstractServiceMetricEsPersistenceDAO implements IServiceDayMetricPersistenceDAO<Index, Update, ServiceMetric> {

    public ServiceDayMetricEsPersistenceDAO(ElasticSearchHttpClient client) {
        super(client);
    }
