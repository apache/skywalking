...
import org.skywalking.apm.collector.storage.es.dao.ApplicationReferenceEsMetricPersistenceDAO;
...
public class StorageModuleEsProvider extends ModuleProvider {
    ...
    private void registerPersistenceDAO() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IApplicationReferenceMetricPersistenceDAO.class, new ApplicationReferenceEsMetricPersistenceDAO(elasticSearchClient));
        ...
        this.registerServiceImplementation(IServiceReferenceMetricPersistenceDAO.class, new ServiceReferenceEsMetricPersistenceDAO(elasticSearchClient));
