...
/**
 * V2 class generator that produces CtClass without loading to JVM.
 * Used for bytecode comparison tests.
 */
public class V2ClassGenerator {
    ...
    public V2ClassGenerator(OALDefine define, ClassPool classPool) {
     ...
     */
    public CtClass generateMetricsCtClass(CodeGenModel model) throws OALCompileException {
     ...
     */
    public CtClass generateDispatcherCtClass(String scopeName, OALClassGeneratorV2.DispatcherContextV2 dispatcherContext) throws OALCompileException {
        ...
        for (CodeGenModel metric : dispatcherContext.getMetrics()) {
            ...
            try {
                ...
                throw new OALCompileException("Can't generate method do" + metric.getMetricsName() + " for " + className, e);
            }
        }
