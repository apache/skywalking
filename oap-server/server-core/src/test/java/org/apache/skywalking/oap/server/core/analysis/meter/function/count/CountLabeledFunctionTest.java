...
import org.apache.skywalking.oap.server.core.analysis.meter.function.count.CountLabeledFunction;
...
public class CountLabeledFunctionTest {
    ...
    @BeforeEach
    public void before() {
        function = new CountLabeledFunctionInst();
    ...
    public void testSerialize() {
        ...
        CountLabeledFunction function2 = new CountLabeledFunctionInst();
    ...
    public void testBuilder() throws IllegalAccessException, InstantiationException {
        ...
        StorageBuilder<CountLabeledFunction> storageBuilder = function.builder().newInstance();
    ...
    private static class CountLabeledFunctionInst extends CountLabeledFunction {
        @Override
        public AcceptableValue<DataTable> createNew() {
            return new CountLabeledFunctionInst();
        }
    }
}
