...
public class OTLPServiceRelationDispatcher implements SourceDispatcher<OTLPServiceRelation> {
    @Override
    public void dispatch(final OTLPServiceRelation source) {
        final OTLPServiceRelationTraffic traffic = new OTLPServiceRelationTraffic();
        traffic.setServiceName(source.getServiceName());
        traffic.setPeerService(source.getPeerService());
