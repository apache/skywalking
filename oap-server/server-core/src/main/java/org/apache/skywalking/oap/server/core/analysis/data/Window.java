...
/**
 * Data cache window. Window holds two data collections(A and B). They are switchable based on outside command.
 * In any time, one collection is accepting the input data, and the other is immutable.
 *
