...
public class TCPBinderRegisterImpl implements TCPBinderRegister {

    private final TCPServerManager tcpServerManager;

    public TCPBinderRegisterImpl(TCPServerManager tcpServerManager) {
        this.tcpServerManager = tcpServerManager;
    }

    @Override
    public void addBinder(TCPBinder binder) {
        tcpServerManager.addBinder(binder);
    }
}
