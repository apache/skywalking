...
@MeterFunction(functionName = "doubleAvg")
@EqualsAndHashCode(of = {
    "entityId",
    "timeBucket"
})
public abstract class DoubleAvgFunction extends DoubleAvgMetrics implements AcceptableValue<Double> {
    @Setter
    @Getter
    ...
    public Metrics toHour() {
        DoubleAvgFunction metrics = (DoubleAvgFunction) createNew();
    ...
    public RemoteData.Builder serialize() {
        ...
        remoteBuilder.addDataDoubles(summation);
    ...
    @Override
    public void accept(final MeterEntity entity, final Double value) {
    ...
    public static class AvgStorageBuilder implements StorageBuilder<DoubleAvgFunction> {
        @Override
        public DoubleAvgFunction map2Data(final Map<String, Object> dbMap) {
            DoubleAvgFunction metrics = new DoubleAvgFunction() {
                @Override
                public AcceptableValue<Double> createNew() {
        ...
        @Override
        public Map<String, Object> data2Map(final DoubleAvgFunction storageData) {
