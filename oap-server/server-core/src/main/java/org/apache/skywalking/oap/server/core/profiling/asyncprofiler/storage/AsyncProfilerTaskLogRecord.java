...
public class AsyncProfilerTaskLogRecord extends Record {
    ...
    public static class Builder implements StorageBuilder<AsyncProfilerTaskLogRecord> {
        @Override
        public AsyncProfilerTaskLogRecord storage2Entity(final Convert2Entity converter) {
            final AsyncProfilerTaskLogRecord log = new AsyncProfilerTaskLogRecord();
        ...
        @Override
        public void entity2Storage(final AsyncProfilerTaskLogRecord storageData, final Convert2Storage converter) {
