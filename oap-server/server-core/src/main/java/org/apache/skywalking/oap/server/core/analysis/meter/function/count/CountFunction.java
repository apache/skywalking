...
@MeterFunction(functionName = "count")
@ToString
public abstract class CountFunction extends Meter implements AcceptableValue<Long>, LongValueHolder {
    ...
    public Metrics toHour() {
        CountFunction metrics = (CountFunction) createNew();
    ...
    public Class<? extends StorageBuilder> builder() {
        return CountStorageBuilder.class;
    }

    public static class CountStorageBuilder implements StorageBuilder<CountFunction> {

        @Override
        public CountFunction storage2Entity(Convert2Entity converter) {
            CountFunction metrics = new CountFunction() {
                @Override
        ...
        @Override
        public void entity2Storage(final CountFunction storageData, final Convert2Storage converter) {
    ...
    public boolean equals(Object o) {
        ...
        final CountFunction function = (CountFunction) o;
