...
public class TraceList {
    private final List<TraceV2> traces;
    private final RetrievedTimeRange retrievedTimeRange;
    //For OAP internal query debugging
    @Setter
    private DebuggingTrace debuggingTrace;

    public TraceList(final RetrievedTimeRange retrievedTimeRange) {
        this.traces = new ArrayList<>();
        this.retrievedTimeRange = retrievedTimeRange;
    }
}
