...
public class AlarmModuleProvider extends ModuleProvider {
    ...
    @Override public void start() throws ServiceNotProvidedException, ModuleStartException {
        final DynamicConfigurationService dynamicConfigurationService =
            getManager().find(ConfigurationModule.NAME).provider().getService(DynamicConfigurationService.class);
