 ...
 */
@Slf4j
public class TraceSegmentHandler implements PulsarHandler {
    ...
    public TraceSegmentHandler(ModuleManager moduleManager,
        ...
        histogram = metricsCreator.createHistogramMetric(
                ...
                new MetricsTag.Values("pulsar-fetcher")
        );
    ...
    public void handle(final Message msg) {
        try {
            SegmentObject segment = SegmentObject.parseFrom(msg.getData());
