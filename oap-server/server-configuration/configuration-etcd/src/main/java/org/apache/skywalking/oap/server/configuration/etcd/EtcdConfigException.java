...
public class EtcdConfigException extends RuntimeException {
    ...
    public EtcdConfigException(Throwable cause) {
        super(cause);
    }

    protected EtcdConfigException(String message, Throwable cause, boolean enableSuppression,
