...
public class TraceSegmentConsumerHandler implements KafkaConsumerHandler {
    ...
    public TraceSegmentConsumerHandler(ModuleManager moduleManager, KafkaConsumerConfig config) {
        ...
        this.traceModuleConfig = (TraceServiceModuleConfig) ((TraceModuleProvider)
            moduleManager.find(TraceModule.NAME).provider()).createConfigBeanIfAbsent();
        ...
        histogram = metricsCreator.createHistogramMetric(
            ...
            new MetricsTag.Keys("protocol"), new MetricsTag.Values("kafka-consumer")
        );
    ...
    private SegmentParserListenerManager listenerManager(TraceServiceModuleConfig traceModuleConfig,
