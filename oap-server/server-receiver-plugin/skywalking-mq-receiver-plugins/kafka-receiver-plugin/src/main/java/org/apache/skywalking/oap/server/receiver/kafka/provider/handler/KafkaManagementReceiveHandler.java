...
@Slf4j
public class KafkaManagementReceiveHandler implements KafkaReceiveHandler {
    public static final String TOPIC_NAME = "skywalking-management";
    ...
    public KafkaManagementReceiveHandler(ModuleManager moduleManager, KafkaReceiverConfig config) {
