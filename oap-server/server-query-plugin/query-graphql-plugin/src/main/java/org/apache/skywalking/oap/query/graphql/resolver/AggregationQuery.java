...
public class AggregationQuery implements GraphQLQueryResolver {
    ...
    public List<TopNEntity> getServiceTopN(final String name, final int topN, final Duration duration,
        final Order order) throws IOException, ParseException {
        ...
        return getQueryService().getServiceTopN(name, topN, StepToDownsampling.transform(duration.getStep()), startTimeBucket, endTimeBucket, order, startTimestamp, endTimestamp);
    }
    ...
    public List<TopNEntity> getAllServiceInstanceTopN(final String name, final int topN, final Duration duration,
        ...
        long startTimestamp = DurationUtils.INSTANCE.startTimeToTimestamp(duration.getStep(), duration.getStart());
        long endTimestamp = DurationUtils.INSTANCE.endTimeToTimestamp(duration.getStep(), duration.getEnd());
        return getQueryService().getAllServiceInstanceTopN(name, topN, StepToDownsampling.transform(duration.getStep()), startTimeBucket, endTimeBucket, order, startTimestamp, endTimestamp);
    }

    public List<TopNEntity> getServiceInstanceTopN(final int serviceId, final String name, final int topN,
        final Duration duration, final Order order) throws IOException, ParseException {
        long startTimeBucket = DurationUtils.INSTANCE.exchangeToTimeBucket(duration.getStart());
        long endTimeBucket = DurationUtils.INSTANCE.exchangeToTimeBucket(duration.getEnd());
        long startTimestamp = DurationUtils.INSTANCE.startTimeToTimestamp(duration.getStep(), duration.getStart());
        long endTimestamp = DurationUtils.INSTANCE.endTimeToTimestamp(duration.getStep(), duration.getEnd());
        return getQueryService().getServiceInstanceTopN(serviceId, name, topN, StepToDownsampling.transform(duration.getStep()), startTimeBucket, endTimeBucket, order, startTimestamp, endTimestamp);
    }
    ...
    public List<TopNEntity> getAllEndpointTopN(final String name, final int topN,
        ...
        long startTimestamp = DurationUtils.INSTANCE.startTimeToTimestamp(duration.getStep(), duration.getStart());
        long endTimestamp = DurationUtils.INSTANCE.endTimeToTimestamp(duration.getStep(), duration.getEnd());
        return getQueryService().getAllEndpointTopN(name, topN, StepToDownsampling.transform(duration.getStep()), startTimeBucket, endTimeBucket, order, startTimestamp, endTimestamp);
    }
    ...
    public List<TopNEntity> getEndpointTopN(final int serviceId, final String name, final int topN,
        ...
        long startTimestamp = DurationUtils.INSTANCE.startTimeToTimestamp(duration.getStep(), duration.getStart());
        long endTimestamp = DurationUtils.INSTANCE.endTimeToTimestamp(duration.getStep(), duration.getEnd());
        return getQueryService().getEndpointTopN(serviceId, name, topN, StepToDownsampling.transform(duration.getStep()), startTimeBucket, endTimeBucket, order, startTimestamp, endTimestamp);
    }
}
