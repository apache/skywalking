...
public class AggregationOp {
    ...
    //                                                   int opType) throws IllegalExpressionException {
    //        for (MQEValues resultValues : result.getResults()) {
    //            OptionalDouble resultValue;
    //            switch (opType) {
    //                case MQEParser.AVG:
    //                    resultValue = resultValues.getValues()
    //                                              .stream()
    //                                              .filter(mqeValue -> !mqeValue.isEmptyValue())
    //                                              .flatMapToDouble(mqeValue -> DoubleStream.of(mqeValue.getDoubleValue()))
    //                                              .average();
    //                    break;
    //                case MQEParser.COUNT:
    //                    resultValue = OptionalDouble.of(
    //                        resultValues.getValues().stream().filter(mqeValue -> !mqeValue.isEmptyValue()).count());
    //                    break;
    //                case MQEParser.MAX:
    //                    resultValue = resultValues.getValues()
    //                                              .stream()
    ...
    //                    break;
    //                case MQEParser.SUM:
    //                    resultValue = OptionalDouble.of(resultValues.getValues()
    //                                                                .stream()
    //                                                                .filter(mqeValue -> !mqeValue.isEmptyValue())
    //                                                                .flatMapToDouble(mqeValue -> DoubleStream.of(
    //                                                                    mqeValue.getDoubleValue()))
