...
public class StorageModuleElasticsearchConfig extends ModuleConfig {
    ...
    /**
     * There are 2 mode for indices storage, which are FUNCTIONAL_AGGREGATION and NO_AGGREGATION. The Storage behavior
     * using NO_AGGREGATION is same with the storage behavior before 8.5.0 version. And, the Storage behavior using
     ...
     * @since 8.5.0
     */
    private String storageMode = "FUNCTIONAL_AGGREGATION";
