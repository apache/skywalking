...
public class PostgreSQLStorageProvider extends ModuleProvider {
    ...
    public void prepare() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IBatchDAO.class, new H2BatchDAO(postgresqlClient, config.getMaxSizeOfBatchSql(), config.getH2AsyncBatchPersistentPoolSize(), config.getH2AsyncBatchPersistentChannelSize()));
