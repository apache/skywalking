...
public class MySQLStorageProvider extends ModuleProvider {
    ...
    public void prepare() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(ITraceQueryDAO.class,
        ...
        this.registerServiceImplementation(IAlarmQueryDAO.class,
        ...
        this.registerServiceImplementation(ILogQueryDAO.class, new MySQLLogQueryDAO(mysqlClient, getManager(), config));
