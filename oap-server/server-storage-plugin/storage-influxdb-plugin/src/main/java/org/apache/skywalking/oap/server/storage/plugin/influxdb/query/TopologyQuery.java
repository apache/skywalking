...
public class TopologyQuery implements ITopologyQueryDAO {
    ...
    public List<Call.CallDetail> loadSpecifiedDestOfServerSideEndpointRelations(Downsampling downsampling,
        ...
        WhereQueryImpl<SelectQueryImpl> query2 = buildServiceCallsQuery(
            measurement,
            startTB,
            endTB,
            EndpointRelationServerSideMetrics.SOURCE_ENDPOINT_ID,
    ...
    private WhereQueryImpl<SelectQueryImpl> buildServiceInstanceCallsQuery(String measurement,
                                                                           long startTB,
                                                                           long endTB,
                                                                           String sourceCName,
                                                                           String destCName,
    ...
    public List<Call.CallDetail> buildCalls(WhereQueryImpl<SelectQueryImpl> query,
