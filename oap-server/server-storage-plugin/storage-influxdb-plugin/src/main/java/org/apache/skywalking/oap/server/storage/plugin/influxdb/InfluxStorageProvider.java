...
import org.apache.skywalking.oap.server.storage.plugin.influxdb.query.ProcessServiceLabelQuery;
...
public class InfluxStorageProvider extends ModuleProvider {
    ...
    public void prepare() throws ServiceNotProvidedException {
        ...
        this.registerServiceImplementation(IProcessServiceLabelDAO.class, new ProcessServiceLabelQuery(client));
    }
