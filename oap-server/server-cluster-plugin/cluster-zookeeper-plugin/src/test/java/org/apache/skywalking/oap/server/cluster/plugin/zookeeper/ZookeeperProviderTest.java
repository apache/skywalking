...
public class ZookeeperProviderTest {
    ...
    public void before() throws Exception {
        server = new TestingServer(12182, true);
    }
    ...
    public void registerRemote() throws Exception {
        ...
        assertEquals(selfAddress.isSelf(), queryAddress.isSelf());
    }

    @Test
    public void registerRemoteOfInternal() throws Exception {
        ClusterModuleZookeeperProvider provider = createProvider("register_remote", "127.0.1.2", 1000);
