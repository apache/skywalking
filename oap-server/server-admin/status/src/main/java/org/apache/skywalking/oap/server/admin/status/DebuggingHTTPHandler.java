...
import org.apache.skywalking.oap.server.admin.status.log.DebuggingQueryLogsRsp;
import org.apache.skywalking.oap.server.admin.status.mqe.DebuggingMQERsp;
import org.apache.skywalking.oap.server.admin.status.topology.DebuggingQueryEndpointTopologyRsp;
import org.apache.skywalking.oap.server.admin.status.topology.DebuggingQueryInstanceTopologyRsp;
import org.apache.skywalking.oap.server.admin.status.topology.DebuggingQueryProcessTopologyRsp;
...
public class DebuggingHTTPHandler {
    ...
    public DebuggingHTTPHandler(final ModuleManager manager, final StatusModuleConfig config) {
