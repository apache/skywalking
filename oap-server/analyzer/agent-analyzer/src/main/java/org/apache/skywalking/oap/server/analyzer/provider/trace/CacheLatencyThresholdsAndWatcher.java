...
public class CacheLatencyThresholdsAndWatcher extends ConfigChangeWatcher {
    ...
    public CacheLatencyThresholdsAndWatcher(String config, ModuleProvider provider) {
        super(AnalyzerModule.NAME, provider, "cacheSlowAccessThreshold");
