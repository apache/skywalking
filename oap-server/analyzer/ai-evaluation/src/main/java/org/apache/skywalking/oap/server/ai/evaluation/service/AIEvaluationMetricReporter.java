...
public class AIEvaluationMetricReporter {
    ...
    private final IMeterProcessService meterProcessService;
    private final NamingControl namingControl;

    public AIEvaluationMetricReporter(final IMeterProcessService meterProcessService,
                                      final NamingControl namingControl) {
        this.meterProcessService = meterProcessService;
