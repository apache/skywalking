...
@Slf4j
public class GRPCMetricsExporter extends MetricFormatter implements MetricValuesExportService {
    /**
    ...
    private BatchQueue<ExportData> queue;
    ...
    void consumeExportData(List<ExportData> data) {
