...
import com.ai.cloud.skywalking.plugin.jdbc.tracing.PreaparedStatementTracing.Executable;
...
public class SWPreparedStatement implements PreparedStatement {
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		return PreaparedStatementTracing.execute(realStatement, connectInfo, "executeQuery", sql, new Executable<ResultSet>() {
	...
	public int executeUpdate(String sql) throws SQLException {
		return PreaparedStatementTracing.execute(realStatement, connectInfo, "executeUpdate", sql, new Executable<Integer>() {
	...
	public boolean execute(String sql) throws SQLException {
		return PreaparedStatementTracing.execute(realStatement, connectInfo, "execute", sql, new Executable<Boolean>() {
	...
	public int[] executeBatch() throws SQLException {
		return PreaparedStatementTracing.execute(realStatement, connectInfo, "executeBatch", "", new Executable<int[]>() {
	...
	public boolean execute() throws SQLException {
		return PreaparedStatementTracing.execute(realStatement, connectInfo, "executeUpdate", sql, new Executable<Boolean>() {
			public Boolean exe(java.sql.PreparedStatement realStatement, String sql)
					throws SQLException {
