...
public class SWCallableStatement implements CallableStatement {
	...
	public ResultSet executeQuery() throws SQLException {
		return CallableStatementTracing.execute(realStatement, connectInfo,
				"executeQuery", sql, new Executable<ResultSet>() {
					public ResultSet exe(
							java.sql.CallableStatement realStatement, String sql)
							throws SQLException {
	...
	public int executeUpdate() throws SQLException {
		return CallableStatementTracing.execute(realStatement, connectInfo,
				"executeUpdate", sql, new Executable<Integer>() {
					public Integer exe(
							java.sql.CallableStatement realStatement, String sql)
							throws SQLException {
	...
	public boolean execute() throws SQLException {
		return CallableStatementTracing.execute(realStatement, connectInfo,
				"execute", sql, new Executable<Boolean>() {
					public Boolean exe(
							java.sql.CallableStatement realStatement, String sql)
							throws SQLException {
	...
	public int[] executeBatch() throws SQLException {
		return CallableStatementTracing.execute(realStatement, connectInfo,
				"executeBatch", "", new Executable<int[]>() {
					public int[] exe(
							java.sql.CallableStatement realStatement, String sql)
							throws SQLException {
