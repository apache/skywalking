            ...
            parallel {
                stage('JDK 1.8 on Linux') {
                    ...
                    stages {
                        ...
                        stage('Test & Report') {
                            steps {
                                sh './mvnw -P"agent,backend,ui,dist,CI-with-IT" org.jacoco:jacoco-maven-plugin:0.8.3:prepare-agent -am clean package org.jacoco:jacoco-maven-plugin:0.8.3:report'
