 ...
 *
 * @deprecated Use {@link com.ai.cloud.io.netty.handler.codec.http.cookie.ServerCookieEncoder} instead
 */
@Deprecated
public final class ServerCookieEncoder {
    ...
    public static String encode(String name, String value) {
        return com.ai.cloud.io.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode(name, value);
    }
    ...
    public static String encode(Cookie cookie) {
        return com.ai.cloud.io.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode(cookie);
    }
    ...
    public static List<String> encode(Cookie... cookies) {
        return com.ai.cloud.io.netty.handler.codec.http.cookie.ServerCookieEncoder.LAX.encode(cookies);
    }
