...
public class CommandSerializer {
    ...
    static {
        ...
        COMMAND_SERIALIZE_MAPPING.put("TraceIgnore", new TraceIgnoreCommand("FOR_DESERIALIZE"));
    }

    public static BaseCommand serialize(Command command) {
        String commandName = command.getCommand();
        Deserializable deserializable = COMMAND_SERIALIZE_MAPPING.get(commandName);
        if (deserializable == null) {
            throw new UnsupportedCommandException(command);
        }

        return deserializable.deserialize(command);
    }
}
