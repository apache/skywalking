...
# otherwise we should add its license to LICENSE file and add the dependency to known-dependencies.txt
diff -U0 tools/dependencies/known-dependencies.txt third-party-dependencies.txt
