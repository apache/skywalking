...
public class MemoryRegister {
    ...
    private MemoryRegister() {
        ...
        try {
            // 读取offset文件
            OffsetFile mainOffsetFile = new OffsetFile(
                    Config.RegisterPersistence.REGISTER_FILE_PARENT_DIRECTORY + File.separator +
                    Config.RegisterPersistence.REGISTER_FILE_NAME, bufferFileNameList);
            OffsetFile backUpOffsetFile = new OffsetFile(
                    Config.RegisterPersistence.REGISTER_FILE_PARENT_DIRECTORY + File.separator +
                    Config.RegisterPersistence.REGISTER_BAK_FILE_NAME, bufferFileNameList);
