...
`logging.dir`|Log files directory. Default is blank string, means, use "{the_skywalking_agent_jar_dir}/../logs  " to output logs. {the_skywalking_agent_jar_dir} is the directory where the skywalking agent jar file is located |`""`|
