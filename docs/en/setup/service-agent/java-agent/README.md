...
`agent.max_wait_channel_auto_connect_count `|Wait for the channel to automatically connect the maximum number of times. Use for make a requestConnection to server to check status.|`1`|
