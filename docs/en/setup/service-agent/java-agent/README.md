...
`agent.trace_segment_ref_limit_per_segment`|The max number of TraceSegmentRef in a single segment. Through this config item, SkyWalking keep your application memory cost estimated.|500 |
