...
`plugin.use_uri_name_as_operate_name`|If true, the request uri name will be used as the operation name instead of the interface class name, default is false.|`false`|
