...
* Plugin of sentinel-1.x in optional plugin folder. The reason of being optional plugin is, sentinel will generate a large number of LocalSpan as currently designed.
