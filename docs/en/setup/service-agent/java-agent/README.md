...
`plugin.dubbo.collect_consumer_address`| Dubbo consumer collect `remote_address` and `local_address` in RPC call. |`false`| 
`plugin.dubbo.collect_consumer_arguments`| Dubbo consumer collect `arguments` in RPC call. |`false`| 
...
`plugin.dubbo.collect_provider_address`| Dubbo provider collect `remote_address` and `local_address` in RPC call. |`false`| 
`plugin.dubbo.collect_provider_arguments`| Dubbo provider collect `arguments` in RPC call. |`false`| 
