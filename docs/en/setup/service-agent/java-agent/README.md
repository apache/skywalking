...
`agent.trace_segment_ref_limit_per_span`|The max number of TraceSegmentRef in a single span. Through this config item, SkyWalking keep your application memory cost estimated.|500 |
