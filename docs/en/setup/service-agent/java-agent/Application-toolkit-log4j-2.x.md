...
The log4j 2.x gRPC reporter supports trasmitting logs as pre-formatted or un-formatted. Transmitting pre-formatted data is the default but can be disabled by adding the following to the agent config:
