...
| configuration-discovery | default | disableMessageDigest | If the current configuration is true, the requestId and uuid will not be judged. | SW_DISABLE_MESSAGE_DIGEST | false
