...
|agent-analyzer.default.slowTraceSegmentThreshold| The threshold used to check the slow trace segment, override `receiver-trace/default/slowTraceSegmentThreshold` of `applciation.yml`. | 2000 |
