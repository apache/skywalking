...
|core.default.log4j-xml| The log4j xml configuration, will override `log4j2.xml`. | same as [`log4j2.xml`](https://logging.apache.org/log4j/2.x/manual/configuration.html#XML) |
