    ...
    public JsonObject buildNodesGraph(JsonArray nodesArray, JsonArray nodeRefArray, JsonObject nodeInst, Map<String, Integer> sumMapping, Map<String, JsonObject> nodeRefResSumMapping) {
        ...
        for (int i = 0; i < nodeRefArray.size(); i++) {
            ...
            if (!nodeMapping.containsKey(front)) {
                ...
                graphNodes.add(createNodeGraph(nodeId, front, config.getImage().get(component), nodeInstSum));
            ...
            if (!nodeMapping.containsKey(behind)) {
                ...
                graphNodes.add(createNodeGraph(nodeId, behind, config.getImage().get(component), nodeInstSum));
