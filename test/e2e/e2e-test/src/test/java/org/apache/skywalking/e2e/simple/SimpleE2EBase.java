...
public class SimpleE2EBase extends SkyWalkingTestAdapter {
    protected Instances verifyServiceInstances(final Service service) throws Exception {
    ...
    protected Endpoints verifyServiceEndpoints(final Service service) throws Exception {
    ...
    protected void verifyInstancesMetrics(final Instances instances) throws Exception {
