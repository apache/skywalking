...
import org.apache.skywalking.e2e.topo.ServiceInstanceTopoResponse;
...
public class SimpleQueryClient {
    ...
    public List<Trace> traces(final TracesQuery query) throws Exception {
        ...
        final ResponseEntity<GQLResponse<TracesData>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<TracesData>>() {
        });
    ...
    public List<Service> services(final ServicesQuery query) throws Exception {
        ...
        final String queryString = Resources.readLines(queryFileUrl, Charset.forName("UTF8"))
                                            ...
                                            .replace("{end}", query.end())
                                            .replace("{step}", query.step());
        final ResponseEntity<GQLResponse<ServicesData>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<ServicesData>>() {
        });
    ...
    public Instances instances(final InstancesQuery query) throws Exception {
        ...
        final String queryString = Resources.readLines(queryFileUrl, Charset.forName("UTF8"))
                                            ...
                                            .replace("{end}", query.end())
                                            .replace("{step}", query.step());
        final ResponseEntity<GQLResponse<Instances>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<Instances>>() {
        });
    ...
    public Endpoints endpoints(final EndpointQuery query) throws Exception {
        ...
        final String queryString = Resources.readLines(queryFileUrl, Charset.forName("UTF8"))
                                            ...
                                            .collect(Collectors.joining())
                                            .replace("{serviceId}", query.serviceId());
        final ResponseEntity<GQLResponse<Endpoints>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<Endpoints>>() {
        });
    ...
    public TopoData topo(final TopoQuery query) throws Exception {
        ...
        final String queryString = Resources.readLines(queryFileUrl, Charset.forName("UTF8"))
                                            ...
                                            .replace("{start}", query.start())
                                            .replace("{end}", query.end());
        final ResponseEntity<GQLResponse<TopoResponse>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<TopoResponse>>() {
        });
    ...
    public ServiceInstanceTopoData serviceInstanceTopo(final ServiceInstanceTopoQuery query) throws Exception {
        ...
        final ResponseEntity<GQLResponse<ServiceInstanceTopoResponse>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<ServiceInstanceTopoResponse>>() {
        });
    ...
    public Metrics metrics(final MetricsQuery query) throws Exception {
        ...
        final String queryString = Resources.readLines(queryFileUrl, Charset.forName("UTF8"))
                                            ...
                                            .replace("{id}", query.id());
        final ResponseEntity<GQLResponse<MetricsData>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<MetricsData>>() {
        });
    ...
    public List<Metrics> multipleLinearMetrics(final MetricsQuery query, String numOfLinear) throws Exception {
        ...
        final ResponseEntity<GQLResponse<MultiMetricsData>> responseEntity = restTemplate.exchange(new RequestEntity<>(queryString, HttpMethod.POST, URI
            .create(endpointUrl)), new ParameterizedTypeReference<GQLResponse<MultiMetricsData>>() {
        });
