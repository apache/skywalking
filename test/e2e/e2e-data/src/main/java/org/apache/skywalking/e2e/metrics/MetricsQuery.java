...
public class MetricsQuery extends AbstractQuery<MetricsQuery> {
    ...
    public static String[] ALL_SO11Y_LINER_METRICS = {
        ...
        METER_INSTANCE_JVM_THREAD_LIVE_COUNT,
        METER_INSTANCE_JVM_THREAD_RUNNABLE_STATE_THREAD_COUNT,
        METER_INSTANCE_JVM_CLASS_LOADED_CLASS_COUNT,
        METER_INSTANCE_JVM_CLASS_TOTAL_LOADED_CLASS_COUNT
    };
