...
@RestController
@RequestMapping("/elasticsearch-case/transport-case")
public class TransportCaseController {

    private static Logger logger = LogManager.getLogger(TransportCaseController.class);
