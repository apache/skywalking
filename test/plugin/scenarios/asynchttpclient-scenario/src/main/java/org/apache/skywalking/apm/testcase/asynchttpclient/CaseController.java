...
public class CaseController {
    ...
    public String asynchttpclientScenario() throws Exception {
        String content = asyncRequest("http://127.0.0.1:8080/asynchttpclient/back");
        return content;
    }
    ...
    public static final String asyncRequest(String url) throws Exception {
        ...
        Request request = new RequestBuilder().setUrl("http://127.0.0.1:8080/asynchttpclient/back").build();
