...
public class FrontController {
    ...
    public String front() {
        asyncRequest("http://localhost:8080/resttemplate-4.x-scenario/resttemplate/back");
        syncRequest("http://localhost:8080/resttemplate-4.x-scenario/resttemplate/back");
        return "Success";
    }
