...
/**
 * 1. The consumer configuration can be obtained through the constructor
 * 2. Calling KafkaConsumer.subscribe represents starting the consumer
 * 3. Calling KafkaConsumer.poll represents pull the messages
 * 4. V2 change pollOnce to pollForFetches
 * @author stalary
 */
public class KafkaConsumerInstrumentation extends AbstractKafkaInstrumentation {
    ...
    private static final String ENHANCE_METHOD = "pollForFetches";
    ...
    private static final String CONSTRUCTOR_INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.kafka.v2.ConsumerConstructorInterceptor";

    private static final String INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.kafka.v2.KafkaConsumerInterceptor";

    private static final String SUBSCRIBE_INTERCEPT_CLASS = "org.apache.skywalking.apm.plugin.kafka.v2.SubscribeMethodInterceptor";
