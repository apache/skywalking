...
@DefaultImplementor
public class JVMServiceSenderImpl implements JVMServiceSender, GRPCChannelListener {
    private static final ILog logger = LogManager.getLogger(JVMServiceSenderImpl.class);
