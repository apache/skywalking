...
public class KafkaProducerManager implements BootService, Runnable {
    ...
    public void prepare() throws Throwable {
        ...
        LOGGER.info("prepare KafkaProducerManager {}", KafkaReporterPluginConfig.Plugin.Kafka.BOOTSTRAP_SERVERS);
        ...
        LOGGER.info("after KafkaProducerManager {}", KafkaReporterPluginConfig.Plugin.Kafka.BOOTSTRAP_SERVERS);
