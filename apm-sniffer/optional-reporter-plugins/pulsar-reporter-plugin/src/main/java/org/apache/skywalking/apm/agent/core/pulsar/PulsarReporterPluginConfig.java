...
public class PulsarReporterPluginConfig {
    public static class Plugin {
        ...
        public static class Pulsar {
            /**
             * <B>service.url</B>: A list of host/port pairs to use for establishing the initial connection to the Pulsar cluster.
             * This list should be in the form host1:port1,host2:port2,...
             */
            public static String SERVICE_URL = "pulsar://localhost:6650";

            public static String TENANT = "public";
            ...
            public static Map<String, Object> PRODUCER_CONFIG = new HashMap<>();
