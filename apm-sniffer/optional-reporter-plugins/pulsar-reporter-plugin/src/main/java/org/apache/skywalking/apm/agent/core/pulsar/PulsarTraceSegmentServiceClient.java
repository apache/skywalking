...
public class PulsarTraceSegmentServiceClient implements BootService, IConsumer<TraceSegment>, TracingContextListener {
    ...
    public void boot() throws InterruptedException {
        ...
        producer = ServiceManager.INSTANCE.findService(PulsarProducerManager.class).getProducer(Pulsar.TOPIC_SEGMENT);
    }
