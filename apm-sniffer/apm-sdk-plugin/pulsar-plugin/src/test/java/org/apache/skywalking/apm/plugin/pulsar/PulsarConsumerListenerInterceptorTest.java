...
public class PulsarConsumerListenerInterceptorTest {
    ...
    public void testConsumerWithNullMessage() throws Throwable {
        consumerListenerInterceptor.beforeMethod(consumerInstance, null, new Object[]{null, null}, new Class[0], null);
        consumerListenerInterceptor.afterMethod(consumerInstance, null, new Object[]{null, null}, new Class[0], null);
    ...
    public void testConsumerWithMessage() throws Throwable {
        consumerListenerInterceptor.beforeMethod(consumerInstance, null, new Object[]{null, msg}, new Class[0], null);
        consumerListenerInterceptor.afterMethod(consumerInstance, null, new Object[]{null, msg}, new Class[0], null);
    ...
    private void assertConsumerSpan(AbstractTracingSpan span) {
        ...
        SpanAssert.assertTag(span, 0, "persistent://my-tenant/my-ns/my-topic");
    }
