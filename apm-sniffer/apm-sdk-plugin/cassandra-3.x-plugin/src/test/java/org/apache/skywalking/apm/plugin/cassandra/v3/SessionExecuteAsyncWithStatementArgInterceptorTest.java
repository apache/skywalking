...
public class SessionExecuteAsyncWithStatementArgInterceptorTest {
    ...
    private SessionExecuteAsyncWithStatementArgInterceptor interceptor;
    ...
    public void setUp() throws Exception {
        interceptor = new SessionExecuteAsyncWithStatementArgInterceptor();
