...
public class InvokeListenerMethodInterceptor implements InstanceMethodsAroundInterceptor {

    public static final String SPRING_KAFKA_INVOKE_LISTENER_OPERATION_NAME = "/spring-kafka/invokeListener";
