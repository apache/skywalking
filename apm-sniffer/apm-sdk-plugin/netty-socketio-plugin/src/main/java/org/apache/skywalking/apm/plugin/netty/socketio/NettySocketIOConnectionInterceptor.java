...
import static org.apache.skywalking.apm.plugin.netty.socketio.NettySocketIOConstants.TAG_FROM;
...
public class NettySocketIOConnectionInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInterceptResult result) throws Throwable {
        ...
        AbstractSpan span = ContextManager.createEntrySpan(NettySocketIOConstants.SPAN_PREFIX + method.getName(), new ContextCarrier());
        ...
        TAG_FROM.set(span, clientAddress);
    }
