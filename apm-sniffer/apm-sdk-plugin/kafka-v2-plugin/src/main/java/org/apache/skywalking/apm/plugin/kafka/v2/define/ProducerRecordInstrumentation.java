...
/**
 * The producer data can be obtained through the constructor
 * @author stalary
 */
public class ProducerRecordInstrumentation extends AbstractKafkaInstrumentation {
    ...
    private static final String CONSTRUCTOR_INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.kafka.v2.ProducerRecordConstructorInterceptor";
