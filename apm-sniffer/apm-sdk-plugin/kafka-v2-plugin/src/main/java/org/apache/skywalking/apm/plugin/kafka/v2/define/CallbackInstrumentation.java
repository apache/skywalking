...
/**
 * 1. When the producer passes in a callback, Callback.onCompletion is called after production
 * @author stalary
 */
public class CallbackInstrumentation extends AbstractKafkaInstrumentation {
    ...
    private static final String INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.kafka.v2.CallbackInterceptor";
