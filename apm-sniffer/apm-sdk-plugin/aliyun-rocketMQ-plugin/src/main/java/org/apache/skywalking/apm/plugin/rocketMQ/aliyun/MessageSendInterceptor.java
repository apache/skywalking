...
package org.apache.skywalking.apm.plugin.rocketMQ.aliyun;
...
import org.apache.skywalking.apm.plugin.rocketMQ.aliyun.define.SendCallBackEnhanceInfo;
...
public class MessageSendInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    private static final String ASYNC_SEND_OPERATION_NAME_PREFIX = "AliyunRocketMQ/";
