 ...
 * HttpServletRequest#getHeader(String)}. The {@link TraceSegment#traceSegmentRef} of current trace segment will reference to the
...
public class TomcatInvokeInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    /**
     * * The {@link TraceSegment#traceSegmentRef} of current trace segment will reference to the trace segment id of the previous
