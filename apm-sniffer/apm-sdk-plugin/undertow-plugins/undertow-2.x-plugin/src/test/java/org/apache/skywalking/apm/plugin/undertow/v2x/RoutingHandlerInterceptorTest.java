...
public class RoutingHandlerInterceptorTest {
    ...
    public void testBindArguments() throws Throwable {
        ...
        assertTrue(TraceContextUtils.isInRoutingHandlerTracing());
    }

    @Test
    public void testStatusCodeIsOk() throws Throwable {
        RoutingHandlerInterceptor.TracingHandler handler = new RoutingHandlerInterceptor.TracingHandler(template, httpHandler);
