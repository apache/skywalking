...
public class UndoLogManagerInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPT_CLASS = "org.apache.skywalking.apm.plugin.seata.interceptor.UndoLogManagerInterceptor";
        ...
        return new StaticMethodsInterceptPoint[] {
            new StaticMethodsInterceptPoint() {
                ...
                public ElementMatcher<MethodDescription> getMethodsMatcher() {
                    return (named("flushUndoLogs"))
                        .or(named("undo"))
                        .or(named("batchDeleteUndoLog"));
                }
