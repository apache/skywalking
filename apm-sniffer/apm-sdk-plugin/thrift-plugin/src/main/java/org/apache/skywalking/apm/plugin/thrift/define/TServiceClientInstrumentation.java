...
public class TServiceClientInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.thrift.TServiceClientInterceptor";
    ...
    public InstanceMethodsInterceptPoint[] getInstanceMethodsInterceptPoints() {
        return new InstanceMethodsInterceptPoint[] {
            new InstanceMethodsInterceptPoint() {
                ...
                public ElementMatcher<MethodDescription> getMethodsMatcher() {
                    return ElementMatchers.named("sendBase").and(ElementMatchers.takesArguments(3))
                                          .or(ElementMatchers.named("receiveBase")
            ...
            new InstanceMethodsInterceptPoint() {
                @Override
                public ElementMatcher<MethodDescription> getMethodsMatcher() {
                    return ElementMatchers.named("sendBaseOneway");
                }
