...
public class AsyncLoggerConfigInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
        ...
        return new InstanceMethodsInterceptPoint[]{
            new InstanceMethodsInterceptPoint() {
                ...
                public String getMethodsInterceptor() {
                    return "org.apache.skywalking.apm.toolkit.activation.log.log4j.v2.x.async.AsyncLoggerConfigMethodInterceptor";
                }
    ...
    protected ClassMatch enhanceClass() {
        return byName("org.apache.logging.log4j.core.async.AsyncLoggerConfig");
    }
}
